    ...
    <div  className={styles.container}>
      <div className={styles.container1} >
        ...
        <div className={styles.image}>
          <img src={lpPics}  alt="landingPage-pic"/>
        </div>
      </div>
      <div  className={styles.container2}>
        <h1 className={styles.h1}>Welcome!</h1>
        <p className={styles.pg}>Enter details to login.</p>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className={styles.input}>
                <input
                  ...
                  required
                />
                <span className={styles.sp} onClick={showPassword}>{show  ? 'HIDE' : 'SHOW'}</span>
              </div>
              <p className={styles.fg}>FORGOT PASSWORD?</p>
                {error && <span>{error}</span>}
            <button className={styles.btLg} type="submit">LOG IN</button> 
          </form>
        </div>
      </div>
    </div>
